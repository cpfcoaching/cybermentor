...
class ChatRequest(BaseModel):
    ...
    user_id: str = Field(..., min_length=1, max_length=128, description="User's session identifier")
    message: str = Field(..., min_length=1, max_length=32768, description="The user's message")
